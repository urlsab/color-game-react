...
function disabledButtons() {
    for(let i = 0; i < 6; i++)buttons[i].disabled = true;
}
function allowAll() {
    for(let i = 0; i < 6; i++)buttons[i].disabled = false;
}
function allowHalf() {
    for(let i = 0; i < 3; i++)buttons[i].disabled = false;
    for(let i = 3; i < 6; i++)buttons[i].disabled = true;
}
function shuffle() {
    for(let i = 0; i < 6; i++){
...
function colorAll() {
    for(let i = 0; i < 6; i++)buttons[i].style.backgroundColor = hardCorect.style.backgroundColor;
}
function colorHalf() {
    for(let i = 0; i < 3; i++)buttons[i].style.backgroundColor = easyCorect.style.backgroundColor;
}
function start() {
    for(let i = 0; i < 6; i++){
        replace1 = rgbString.replace(/ /i, getRndInteger(0, 255));
